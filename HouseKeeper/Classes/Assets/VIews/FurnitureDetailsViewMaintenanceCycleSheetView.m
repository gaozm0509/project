//
//  FurnitureDetailsViewMaintenanceCycleSheetView.m
//  HouseKeeper
//
//  Created by 高泽民 on 16/10/20.
...
@implementation FurnitureDetailsViewMaintenanceCycleSheetView
...
- (UITextField *)nameField{
    if (!_nameField) {
        _nameField = [self nomalTextFieldWithleftViewTitle:@"周期" placeholder:@"请输入保养周期（天）"];
    }
    return _nameField;
}
