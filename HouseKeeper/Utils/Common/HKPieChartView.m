...
//                                 (id)[UIColor colorWithRed:0.000 green:0.502 blue:1.000 alpha:1.000].CGColor];
        _gradientLayer.colors = @[(id)[UIColor colorWithHexString:@"FF7143"].CGColor,
                                                            (id)[UIColor colorWithHexString:@"FFD937"].CGColor];
...
- (UILabel *)progressLabel {
    if (!_progressLabel) {
        ...
        _progressLabel.textColor = [UIColor colorWithHexString:@"E68E51"];
